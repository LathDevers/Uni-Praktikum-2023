...
- [X] Flutter SDK herunterladen.
- [X] Flutter zur Umgebungsvariable `PATH` hinzufügen.
- [X] Android Studio und Plugins installieren.
- [X] `flutter doctor` Fehlermeldungen beheben.
- [X] USB-debugging vorbereiten.
